...
public class RoutinesID {
    ...
    public static final String EDIT_POSITION="call ePetDB.editPosition(?,?,?,?)";

    public static final String EDIT_DESCRIPTION="call ePetDB.editDescription(?,?)";
    public static final String EDIT_PASSWORD="call ePetDB.editPassword(?,?)";
    ...
    public static final String ADD_POST_IMAGE="call ePetDB.insert_post_image(?,?)";
