...
public class ProfileDAO {
    ...
    public static Boolean createProfile(Profile profile) throws SQLException{
       ...
       try{
           ...
           RoutinesManager.bindParametersAndExecNoOutParam(stmt, profile.getUser(), profile.getName(), profile.getLastName(),  profile.getBirthday(),profile.getTelephone(),profile.getNickname());
    ...
    public static void editProfilePicture(Profile p, String pic) throws SQLException,IOException{
        CallableStatement stmt = null;
        try{
            Connection conn = ConnectionManager.getConnection();
    ...
    public static void processResearch(ResultSet res, List<Profile> list) throws SQLException, NoResultFoundException{
        ...
        do{
           ...
           prof.setLastName(res.getString("cognome"));
