...
import presentation.view.PostSlotItemController;
...
public class FavoriteItemGraphic {
    ...
    protected void initResults(ObservableList<SlotAppuntamentoBean> list, FavoriteItemGraphic f) throws IOException, NoResultFoundException{
            if(f.getClass()==presentation.view.FavoriteItemController.class){

                HBox resultsBox=((FavoriteItemController) f).getResultsBox();
                ...
                for(SlotAppuntamentoBean i: list) {
                    ...
                    presentation.view.PostSlotItemController slotControl=p.getController();
                    Pane pane=p.getPane();
